...
function exibirResultado(inscricaoImobiliaria, fatoresCorrecao, areasInfracao, BMC, VMC) {
    ...
    const memorial = `
        ...
        <p>BMC = ${fatoresCorrecao.vmq.valor.toFixed(2)} x ${fatoresCorrecao.ft.valor.toFixed(2)} x ${fatoresCorrecao.fv.valor.toFixed(2)} x ${fatoresCorrecao.fs.valor.toFixed(2)} x ${fatoresCorrecao.fa.valor.toFixed(2)} x ${fatoresCorrecao.fi.valor.toFixed(2)} x ${fatoresCorrecao.fu.valor.toFixed(2)} x ${fatoresCorrecao.fl.valor.toFixed(2)} x 252,59 = ${BMC.toFixed(2)}</p>
        ...
        <p>Observação: UFM = Unidade Fiscal Municipal = R$252,59 (DECRETO Nº 13.857, DE 13 DE NOVEMBRO DE 2025).</p>
